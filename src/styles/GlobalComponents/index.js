...
export const ImageContainer = styled.div`
  ...
  @media ${(props) => props.theme.breakpoints.sm} {
    display: ${(props) => (props.smOnly ? "inherit" : "none")};
  }
  @media ${(props) => props.theme.breakpoints.md} {
    display: ${(props) => (props.lgOnly ? "inherit" : "none")};
  }
`;
export const SvgContainer = styled.div`
  ...
  @media ${(props) => props.theme.breakpoints.sm} {
    width: ${(props) => (props.mobile ? props.mobile : "inherit")};
    margin: 2em;
  }
  @media ${(props) => props.theme.breakpoints.md} {
    width: ${(props) => (props.desktop ? props.desktop : "inherit")};
  }
`;
